...
class WM_OT_url_open_preset(Operator):
    ...
    @staticmethod
    def _url_for_google_drive():
        return "https://drive.google.com/drive/folders/145qRP6_7rUdUEoyKACxE_P6pJmPBniQR?usp=drive_link"
    ...
    preset_items = [
        ...
        (('BUG', iface_("Bug"),
         ...
         _url_from_bug),
        (('GOOGLE_DRIVE', iface_("Google Drive"),
          tip_("The Google Drive for Project Tether.")),
         _url_for_google_drive),
        ...
        (('FUND', iface_("Development Fund"),
          tip_("The documentation site for Studio Aspen!")),
         "https://sites.google.com/egdcollective.org/studioaspen/home?authuser=0"),
        (('BLENDER', "blender.org",
...
class WM_MT_splash(Menu):
    ...
    def draw(self, context):
        ...
        col2.operator("wm.url_open_preset", text="Google Drive", icon='URL').type = 'GOOGLE_DRIVE'
        col2.operator("wm.url_open_preset", text="Aspen Documentation", icon='FUND').type = 'FUND'
